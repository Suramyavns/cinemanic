...
class TopshowsRowWidget extends StatefulWidget {
  const TopshowsRowWidget({super.key, required this.title, required this.data});

  final String title;

  final TopRatedTvResponse data;

  @override
  State<TopshowsRowWidget> createState() => _TrendingRowWidgetState();
}

class _TrendingRowWidgetState extends State<TopshowsRowWidget> {
  // 1. Define abstract methods that children MUST implement
  late List<TvShow> results;
